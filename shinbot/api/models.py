...
class EC:
    ...
    RESTART_ALREADY_REQUESTED = "RESTART_ALREADY_REQUESTED"
    ...
    CONTEXT_STRATEGY_NOT_FOUND = "CONTEXT_STRATEGY_NOT_FOUND"
    CONTEXT_STRATEGY_ALREADY_EXISTS = "CONTEXT_STRATEGY_ALREADY_EXISTS"
    AGENT_NOT_FOUND = "AGENT_NOT_FOUND"
    AGENT_ALREADY_EXISTS = "AGENT_ALREADY_EXISTS"
    PROMPT_NOT_FOUND = "PROMPT_NOT_FOUND"
    PROMPT_ALREADY_EXISTS = "PROMPT_ALREADY_EXISTS"
    BOT_CONFIG_NOT_FOUND = "BOT_CONFIG_NOT_FOUND"
    BOT_CONFIG_ALREADY_EXISTS = "BOT_CONFIG_ALREADY_EXISTS"
