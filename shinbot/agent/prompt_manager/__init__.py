...
_EXPORT_MODULES = {
    ...
    "PromptBuildResult": "shinbot.agent.prompt_manager.schema",
    ...
    "PromptContextPolicy": "shinbot.agent.prompt_manager.schema",
    "PromptInjection": "shinbot.agent.prompt_manager.schema",
