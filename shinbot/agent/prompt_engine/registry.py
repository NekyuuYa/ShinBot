...
from shinbot.agent.prompt_engine.rendering import (
...
from shinbot.agent.prompt_engine.snapshots import (
...
def _normalize_content_blocks(value: Any) -> list[dict[str, Any]] | None:
    from shinbot.agent.prompt_engine.rendering import _extract_content_blocks
