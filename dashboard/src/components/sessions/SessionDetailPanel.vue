    ...
    <v-row class="mx-0">
      <v-col cols="12" lg="7" class="pa-2">
        <session-history-panel
          ...
          :empty-history-label="emptyHistoryLabel"
          :page-size-label="pageSizeLabel"
          :previous-page-label="previousPageLabel"
          :next-page-label="nextPageLabel"
          :unknown-sender-label="unknownSenderLabel"
          :mentioned-label="mentionedLabel"
          :format-timestamp="formatTimestamp"
          :stringify-content="stringifyContent"
          :agent-read-state-label="agentReadStateLabel"
          :agent-read-state-color="agentReadStateColor"
          :routing-status-label="routingStatusLabel"
          :routing-skip-reason-label="routingSkipReasonLabel"
          :routing-color="routingColor"
          @update:history-page-size="$emit('update:historyPageSize', $event)"
          @previous-history-page="$emit('previous-history-page')"
          @next-history-page="$emit('next-history-page')"
        />
      </v-col>
...
import SessionHistoryPanel from '@/components/sessions/SessionHistoryPanel.vue'
