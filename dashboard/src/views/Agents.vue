<template>
  <v-container fluid class="pa-0 agents-page">
    ...
    <agent-runtime-profiles
      ...
      :idle-review-planning-label="$t('pages.agents.labels.idleReviewPlanning')"
      :model-result-label="$t('pages.agents.labels.modelResult')"
      :application-label="$t('pages.agents.labels.application')"
      :next-review-plan-label="$t('pages.agents.labels.nextReviewPlan')"
      :model-execution-label="$t('pages.agents.labels.modelExecution')"
